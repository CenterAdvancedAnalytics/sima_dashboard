...
def cargar_coctel_completo():
    print("⏳ [START] cargar_coctel_completo()", flush=True)
    t0 = time.time()
    ...
    temp_coctel_completo['rebote_nombre'] = temp_coctel_completo['canal_nombre'].fillna(temp_coctel_completo['nombre_facebook_page'])
